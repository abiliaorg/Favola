    ...
    const CAL_FIX_WINDOW_MS  = 500;   // how long the gaze must stay stable
    const CAL_FIX_DISP       = 0.045; // max normalized bounding-box spread of a fixation
    const CAL_MIN_SAMPLES    = 8;     // min samples inside the window
    const CAL_POINT_TIMEOUT  = 4000;  // give up on a point after this
